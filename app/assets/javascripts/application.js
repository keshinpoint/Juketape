...
$(document).on('turbolinks:load', function() {
  ...
  $('input[type=radio]').change(function() {
    if ($('.invite-radio').is(':checked')) {
      ...
      //contd.frm above; the labels parent is the radio button div. The next sibling is the div of the form field for the message  
      next_form.show();
      ...
      function updateCountdown() {
        ...
        var char_counter = $('.invite-char-counter');
